...
from forum.users.forms import (RegistrationForm, LoginForm, UpdateAccountForm,
                                   RequestResetForm, ResetPasswordForm)
from forum.users.utils import save_picture, send_reset_email
...
@users.route("/user_posts/<current_user>", methods=['GET', 'POST'])
@login_required
